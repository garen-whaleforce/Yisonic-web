const content = {
  zh: {
    ...
    "nav-servo": "伺服馬達方案",
    "nav-adv": "優勢比較",
    "nav-manufacturing": "製造與夥伴",
    "nav-contact": "聯絡我們",
    "lang-zh": "繁體中文",
    "lang-zh-cn": "简体中文",
    "lang-en": "English",
    "lang-ja": "日本語",
    "hero-title": "超聲波，驅動次世代精密感測",
    "hero-subtitle": "奕芯半導體專注於氮化鋁 (AlN) 壓電微機電超聲波換能器 (PMUT) 晶片與模組，將「聲音」轉化為角度、識別、距離、速度與密度的高精度感測能力，為機器人、車用與工業控制帶來更穩定、更可靠的解決方案。",
    "hero-cta-1": "了解技術優勢",
    "hero-cta-2": "聯絡我們",
    "hero-bullet-1": "自主開發 AlN 基 PMUT 晶片與超聲波感測系統",
    "hero-bullet-2": "真正非接觸、抗電磁與耐高溫的角度與距離量測",
    "hero-bullet-3": "結合伺服馬達與客製化微型馬達，打造完整 AIDVD 解決方案",
    "hero-visual-title": "AlN PMUT",
    "hero-visual-highlight": "超聲波智慧",
    "hero-visual-note": "Angle · Identification · Distance · Velocity · Density",
    "about-title": "關於奕芯與同美",
    "about-subtitle": "從台北到深圳，串聯研發與通路，讓超聲波智慧更貼近市場。",
    "about-card-1-title": "奕芯半導體（台北）",
    "about-card-2-title": "創辦人與研發",
    "about-card-3-title": "同美 TOUNGMEI（香港 / 深圳 / 上海）",
    "about-paragraph-1": "奕芯半導體 YiSONIC Semi.（台北）專注於自主開發氮化鋁 (AlN) 基壓電微機電超聲波換能器 (PMUT) 晶片，憑藉自研超聲波技術，提供「角度 Angle、識別 Identification、距離 Distance、速度 Velocity、密度 Density」五大維度的完整感測與量測解決方案。",
    "about-paragraph-2": "創辦人兼總經理邱奕翔博士畢業於北京大學集成電路學院，長期耕耘 AlN PMUT 超聲波技術，發表多篇國際期刊與會議論文，累積超過 20 篇學術成果與 29 項以上發明專利，致力於將學術成果商品化，導入真實應用場域。",
    "about-paragraph-3": "同美 TOUNGMEI（香港 / 深圳 / 上海）擁有超過 30 年的電子零組件銷售與通路經驗，服務超過 300 家客戶，涵蓋車用、行動裝置、家電與機器人等產業，產品組合包含無刷直流馬達、連接器與精密零件，是奕芯技術落地的重要夥伴。",
    "about-metric-1-title": "29+",
    "about-metric-1-desc": "專利與研發成果",
    "about-metric-2-title": "30+",
    "about-metric-2-desc": "年通路與銷售經驗",
    "about-metric-3-title": "300+",
    "about-metric-3-desc": "服務客戶與合作品牌",
    "tech-title": "核心技術：AlN PMUT 超聲波微機電",
    "tech-subtitle": "從結構設計到訊號讀出，打造高穩定、高解析度的超聲波晶片。",
    "tech-card-1-title": "創新懸吊結構",
    "tech-card-1-desc": "採用雙樑懸吊結構的 AlN 基 PMUT，提升聲壓輸出並擴大發射角度，適合短距與中距量測與空間受限應用。",
    "tech-card-2-title": "溫度可靠度",
    "tech-card-2-desc": "針對環境溫度變化進行實測與模型驗證，強化 PMUT 在實際應用中的溫度穩定性，可用於電源電子與高功率系統的熱管理監控。",
    "tech-card-3-title": "低功耗 TDC 讀出電路",
    "tech-card-3-desc": "研發整合 PMUT 的超聲波 Time-of-Flight 讀出晶片，可達 5,000 mm 量測距離，距離誤差約 0.63 mm，適合電池供電與高整合度感測模組。",
    "highlight-1-title": "5 m",
    "highlight-1-desc": "超聲波量測距離",
    "highlight-2-title": "≈ 0.63 mm",
    "highlight-2-desc": "距離量測誤差",
    "highlight-3-title": "雙樑懸吊",
    "highlight-3-desc": "提升聲壓與發射角",
    "aidvd-title": "AIDVD 超聲波智慧 ― Angle / Identification / Distance / Velocity / Density",
    "aidvd-subtitle": "以聲音為核心，重構機器感知世界的方式。",
    "aidvd-pill-a": "A",
    "aidvd-pill-i": "I",
    "aidvd-pill-d": "D",
    "aidvd-pill-v": "V",
    ...
    "aidvd-card-a-desc": "量測轉角與旋轉位置。",
    "aidvd-card-a-adv": "真正非接觸感測，不受磁場與溫度干擾。",
    "aidvd-card-a-app": "應用：伺服馬達關節、機器人關節、精密致動器。",
    "aidvd-card-i-heading": "Identification（識別）",
    "aidvd-card-i-desc": "透過聲學特徵識別不同材料或物體。",
    "aidvd-card-i-adv": "實現智慧化感測與分類。",
    "aidvd-card-i-app": "應用：工業檢測、智慧機器人、材料分選。",
    "aidvd-card-d-heading": "Distance（距離）",
    "aidvd-card-d-desc": "利用超聲波飛行時間或相位差量測距離與位置。",
    "aidvd-card-d-adv": "高解析度量測，不受光線與磁場影響。",
    "aidvd-card-d-app": "應用：自動化系統、無人機、避障與安全距離監控。",
    "aidvd-card-v-heading": "Velocity（速度）",
    "aidvd-card-v-desc": "利用都卜勒效應量測運動速度或流速。",
    "aidvd-card-v-adv": "不受光學限制的即時運動追蹤。",
    "aidvd-card-v-app": "應用：流體監測、馬達回授、機器人導航。",
    "aidvd-card-d2-heading": "Density（密度）",
    "aidvd-card-d2-desc": "藉由聲速與介質關係推算材料或液體密度。",
    "aidvd-card-d2-adv": "無需接觸或取樣即可進行監測。",
    "aidvd-card-d2-app": "應用：製程控制、液體分析、工業感測。",
    "servo-title": "超聲波伺服馬達角度感測方案",
    "servo-subtitle": "為類人機器人與高階伺服系統打造新一代非接觸角度回授。",
    "servo-paragraph-1": "類人機器人市場預估將快速成長，單機常搭載 18 顆以上伺服馬達，伺服系統的精度、可靠度與耐用性直接影響整體性能與成本。",
    "servo-paragraph-2": "傳統伺服馬達多依賴電位器、磁性感測或光學編碼器進行位置回授，可能面臨磨耗、磁干擾或光學對位與污染問題。奕芯結合同美的馬達研發與製造能力，導入自研超聲波感測器與讀出電路。",
    "servo-list-title": "方案特點",
    "servo-list-1": "高精度、非接觸角度量測",
    "servo-list-2": "高靈敏度且耐高溫環境",
    "servo-list-3": "不受電磁場與光學污染影響",
    "servo-list-4": "適合機器人關節、雲台、工業伺服與車用執行器",
    "adv-title": "與傳統非接觸感測技術的比較",
    "adv-subtitle": "光學與磁性感測很成熟，但在極端環境裡，超聲波提供更穩定的選項。",
    "adv-th-tech": "技術",
    "adv-th-advantage": "優點",
    "adv-th-limit": "限制",
    "adv-th-application": "典型應用",
    "adv-optical-tech": "光學編碼器",
    "adv-optical-adv": "解析度與精度極高、重複性佳、免受磁場干擾。",
    "adv-optical-limit": "對灰塵、油污、濕氣與震動敏感，需要乾淨光路與精準對位。",
    "adv-optical-app": "—",
    "adv-hall-tech": "霍爾 / 磁性感測",
    "adv-hall-adv": "體積小、成本相對低、無磨耗，適用溫度範圍廣。",
    "adv-hall-limit": "動態範圍有限，需考量外加磁場干擾與長期漂移。",
    "adv-hall-app": "—",
    "adv-ultra-tech": "奕芯超聲波感測",
    "adv-ultra-adv": "真正非接觸感測，不受磁場、光學與電氣干擾；在高溫與強磁場環境下仍具高穩定性；無需光學對位或磁屏蔽，可望透過 MEMS 超聲波晶片降低系統成本。",
    "adv-ultra-limit": "空間解析度通常低於最高階光學編碼器；需考量氣流、濕度與聲學噪聲影響；需精準設計聲路與結構校準。",
    "adv-ultra-app": "高溫、高磁場或粉塵環境的伺服系統、次世代機器人關節等。",
    "manu-title": "製造能量與策略夥伴",
    "manu-subtitle": "從晶片、感測模組到微型馬達，打造可量產的完整解決方案。",
    "manu-item-1-title": "馬達研發與自有製造能力",
    "manu-item-1-desc": "提供多系列直流與無刷直流馬達、齒輪箱與機構設計，可依應用需求（如醫療設備、機器人、智慧穿戴）進行客製化設計。",
    "manu-item-2-title": "研發與專利",
    "manu-item-2-desc": "超過 50 位研發工程師與 60+ 項與微型馬達與控制相關專利，支援奕芯超聲波技術快速導入客戶平台。",
    "manu-item-3-title": "自動化產線",
    "manu-item-3-desc": "超過 1000 套自動化設備，確保量產良率與交期穩定，涵蓋馬達組裝、測試與品質追溯。",
    "manu-item-4-title": "雲台與精密控制方案",
    "manu-item-4-desc": "高性能雲台系統，支援高負載與高精度控制，角度解析度可達 0.0005° 等級，並支援各式鏡頭資料、視角量測與動態平衡調整，適用於雷達、無人機與影像系統。",
    "contact-title": "聯絡我們",
    "contact-subtitle": "如果您正在思考下一代精密感測或伺服系統，歡迎與奕芯半導體聯繫。",
    "contact-company-label": "公司：",
    "contact-company": "奕芯半導體股份有限公司 YiSONIC Semi.",
    "contact-person-label": "聯絡人：",
    ...
    "form-message-label": "需求 / 訊息",
    "form-message-placeholder": "請留下訊息",
    "form-submit": "送出",
    "form-success": "已收到您的訊息，感謝聯繫！",
    "form-error": "請填寫所有欄位。",
    "form-invalid-email": "請輸入有效的 Email。",
    "footer-text": "奕芯半導體 YiSONIC Semi. · The Sound of Precision"
  },
  "zh-cn": {
    "site-title": "奕芯半导体 YiSONIC Semi.",
    "brand-tagline": "The Sound of Precision",
    "logo-mark": "Yi",
    "nav-home": "首页",
    "nav-about": "关于我们",
    ...
    "nav-servo": "伺服马达方案",
    "nav-adv": "优势比较",
    "nav-manufacturing": "制造与伙伴",
    "nav-contact": "联络我们",
    "lang-zh": "繁體中文",
    "lang-zh-cn": "简体中文",
    "lang-en": "English",
    "lang-ja": "日本語",
    "hero-title": "超声波，驱动次世代精密感测",
    "hero-subtitle": "奕芯半导体专注于氮化铝 (AlN) 压电微机电超声波换能器 (PMUT) 芯片与模组，将“声音”转化为角度、识别、距离、速度与密度的高精度感测能力，为机器人、车用与工业控制带来更稳定、更可靠的解决方案。",
    "hero-cta-1": "了解技术优势",
    "hero-cta-2": "联络我们",
    "hero-bullet-1": "自主开发 AlN 基 PMUT 芯片与超声波感测系统",
    "hero-bullet-2": "真正非接触、抗电磁与耐高温的角度与距离量测",
    "hero-bullet-3": "结合伺服马达与客制化微型马达，打造完整 AIDVD 解决方案",
    "hero-visual-title": "AlN PMUT",
    "hero-visual-highlight": "超声波智慧",
    "hero-visual-note": "Angle · Identification · Distance · Velocity · Density",
    "about-title": "关于奕芯与同美",
    "about-subtitle": "从台北到深圳，串联研发与通路，让超声波智慧更贴近市场。",
    "about-card-1-title": "奕芯半导体（台北）",
    "about-card-2-title": "创办人与研发",
    "about-card-3-title": "同美 TOUNGMEI（香港 / 深圳 / 上海）",
    "about-paragraph-1": "奕芯半导体 YiSONIC Semi.（台北）专注于自主开发氮化铝 (AlN) 基压电微机电超声波换能器 (PMUT) 芯片，凭借自研超声波技术，提供「角度 Angle、识别 Identification、距离 Distance、速度 Velocity、密度 Density」五大维度的完整感测与量测解决方案。",
    "about-paragraph-2": "创办人兼总经理邱奕翔博士毕业于北京大学集成电路学院，长期耕耘 AlN PMUT 超声波技术，发表多篇国际期刊与会议论文，累积超过 20 篇学术成果与 29 项以上发明专利，致力于将学术成果商品化，导入真实应用场域。",
    "about-paragraph-3": "同美 TOUNGMEI（香港 / 深圳 / 上海）拥有超过 30 年的电子零组件销售与通路经验，服务超过 300 家客户，涵盖车用、行动装置、家电与机器人等产业，产品组合包含无刷直流马达、连接器与精密零件，是奕芯技术落地的重要伙伴。",
    "about-metric-1-title": "29+",
    "about-metric-1-desc": "专利与研发成果",
    "about-metric-2-title": "30+",
    "about-metric-2-desc": "年通路与销售经验",
    "about-metric-3-title": "300+",
    "about-metric-3-desc": "服务客户与合作品牌",
    "tech-title": "核心技术：AlN PMUT 超声波微机电",
    "tech-subtitle": "从结构设计到讯号读出，打造高稳定、高解析度的超声波芯片。",
    "tech-card-1-title": "创新悬吊结构",
    "tech-card-1-desc": "采用双梁悬吊结构的 AlN 基 PMUT，提升声压输出并扩大发射角度，适合短距与中距量测与空间受限应用。",
    "tech-card-2-title": "温度可靠度",
    "tech-card-2-desc": "针对环境温度变化进行实测与模型验证，强化 PMUT 在实际应用中的温度稳定性，可用于电源电子与高功率系统的热管理监控。",
    "tech-card-3-title": "低功耗 TDC 读出电路",
    "tech-card-3-desc": "研发整合 PMUT 的超声波 Time-of-Flight 读出芯片，可达 5,000 mm 量测距离，距离误差约 0.63 mm，适合电池供电与高整合度感测模组。",
    "highlight-1-title": "5 m",
    "highlight-1-desc": "超声波量测距离",
    "highlight-2-title": "≈ 0.63 mm",
    "highlight-2-desc": "距离量测误差",
    "highlight-3-title": "双梁悬吊",
    "highlight-3-desc": "提升声压与发射角",
    "aidvd-title": "AIDVD 超声波智慧 ― Angle / Identification / Distance / Velocity / Density",
    "aidvd-subtitle": "以声音为核心，重构机器感知世界的方式。",
    "aidvd-pill-a": "A",
    "aidvd-pill-i": "I",
    "aidvd-pill-d": "D",
    "aidvd-pill-v": "V",
    "aidvd-pill-d2": "D",
    "aidvd-card-a-heading": "Angle（角度）",
    "aidvd-card-a-desc": "量测转角与旋转位置。",
    "aidvd-card-a-adv": "真正非接触感测，不受磁场与温度干扰。",
    "aidvd-card-a-app": "应用：伺服马达关节、机器人关节、精密致动器。",
    "aidvd-card-i-heading": "Identification（识别）",
    "aidvd-card-i-desc": "透过声学特征识别不同材料或物体。",
    "aidvd-card-i-adv": "实现智慧化感测与分类。",
    "aidvd-card-i-app": "应用：工业检测、智慧机器人、材料分选。",
    "aidvd-card-d-heading": "Distance（距离）",
    "aidvd-card-d-desc": "利用超声波飞行时间或相位差量测距离与位置。",
    "aidvd-card-d-adv": "高解析度量测，不受光线与磁场影响。",
    "aidvd-card-d-app": "应用：自动化系统、无人机、避障与安全距离监控。",
    "aidvd-card-v-heading": "Velocity（速度）",
    "aidvd-card-v-desc": "利用都卜勒效应量测运动速度或流速。",
    "aidvd-card-v-adv": "不受光学限制的即时运动追踪。",
    "aidvd-card-v-app": "应用：流体监测、马达回授、机器人导航。",
    "aidvd-card-d2-heading": "Density（密度）",
    "aidvd-card-d2-desc": "借由声速与介质关系推算材料或液体密度。",
    "aidvd-card-d2-adv": "无需接触或取样即可进行监测。",
    "aidvd-card-d2-app": "应用：制程控制、液体分析、工业感测。",
    "servo-title": "超声波伺服马达角度感测方案",
    "servo-subtitle": "为类人机器人与高阶伺服系统打造新一代非接触角度回授。",
    "servo-paragraph-1": "类人机器人市场预估将快速成长，单机常搭载 18 颗以上伺服马达，伺服系统的精度、可靠度与耐用性直接影响整体性能与成本。",
    "servo-paragraph-2": "传统伺服马达多依赖电位器、磁性感测或光学编码器进行位置回授，可能面临磨耗、磁干扰或光学对位与污染问题。奕芯结合同美的马达研发与制造能力，导入自研超声波感测器与读出电路。",
    "servo-list-title": "方案特点",
    "servo-list-1": "高精度、非接触角度量测",
    "servo-list-2": "高灵敏度且耐高温环境",
    "servo-list-3": "不受电磁场与光学污染影响",
    "servo-list-4": "适合机器人关节、云台、工业伺服与车用执行器",
    "adv-title": "与传统非接触感测技术的比较",
    "adv-subtitle": "光学与磁性感测很成熟，但在极端环境里，超声波提供更稳定的选项。",
    "adv-th-tech": "技术",
    "adv-th-advantage": "优点",
    "adv-th-limit": "限制",
    "adv-th-application": "典型应用",
    "adv-optical-tech": "光学编码器",
    "adv-optical-adv": "解析度与精度极高、重复性佳、免受磁场干扰。",
    "adv-optical-limit": "对灰尘、油污、湿气与震动敏感，需要干净光路与精准对位。",
    "adv-optical-app": "—",
    "adv-hall-tech": "霍尔 / 磁性感测",
    "adv-hall-adv": "体积小、成本相对低、无磨耗，适用温度范围广。",
    "adv-hall-limit": "动态范围有限，需考量外加磁场干扰与长期漂移。",
    "adv-hall-app": "—",
    "adv-ultra-tech": "奕芯超声波感测",
    "adv-ultra-adv": "真正非接触感测，不受磁场、光学与电气干扰；在高温与强磁场环境下仍具高稳定性；无需光学对位或磁屏蔽，可望透过 MEMS 超声波芯片降低系统成本。",
    "adv-ultra-limit": "空间解析度通常低于最高阶光学编码器；需考量气流、湿度与声学噪声影响；需精准设计声路与结构校准。",
    "adv-ultra-app": "高温、高磁场或粉尘环境的伺服系统、次世代机器人关节等。",
    "manu-title": "制造能量与策略伙伴",
    "manu-subtitle": "从芯片、感测模组到微型马达，打造可量产的完整解决方案。",
    "manu-item-1-title": "马达研发与自有制造能力",
    "manu-item-1-desc": "提供多系列直流与无刷直流马达、齿轮箱与机构设计，可依应用需求（如医疗设备、机器人、智慧穿戴）进行客制化设计。",
    "manu-item-2-title": "研发与专利",
    "manu-item-2-desc": "超过 50 位研发工程师与 60+ 项与微型马达与控制相关专利，支援奕芯超声波技术快速导入客户平台。",
    "manu-item-3-title": "自动化产线",
    "manu-item-3-desc": "超过 1000 套自动化设备，确保量产良率与交期稳定，涵盖马达组装、测试与品质追溯。",
    "manu-item-4-title": "云台与精密控制方案",
    "manu-item-4-desc": "高性能云台系统，支援高负载与高精度控制，角度解析度可达 0.0005° 等级，并支援各式镜头资料、视角量测与动态平衡调整，适用于雷达、无人机与影像系统。",
    "contact-title": "联络我们",
    "contact-subtitle": "如果您正在思考下一代精密感测或伺服系统，欢迎与奕芯半导体联系。",
    "contact-company-label": "公司：",
    "contact-company": "奕芯半导体股份有限公司 YiSONIC Semi.",
    "contact-person-label": "联络人：",
    "contact-person": "Eason, Y.H. Chiu Ph.D.",
    "contact-email-label": "Email：",
    "contact-email": "eason@yisonic.com",
    "contact-website-label": "Website：",
    ...
    "form-company-label": "公司",
    "form-company-placeholder": "公司",
    "form-message-label": "需求 / 讯息",
    "form-message-placeholder": "请留下讯息",
    "form-submit": "送出",
    "form-success": "已收到您的讯息，感谢联络！",
    "form-error": "请填写所有栏位。",
    "form-invalid-email": "请输入有效的 Email。",
    "footer-text": "奕芯半导体 YiSONIC Semi. · The Sound of Precision"
  },
  en: {
...
const applyLanguage = (lang) => {
  ...
  const langAttr =
    targetLang === "zh" ? "zh-Hant" : targetLang === "zh-cn" ? "zh-Hans" : targetLang;
