const content = {
  ...
  en: {
    ...
    "about-paragraph-1": "YiSONIC focuses on independently developed AlN-based PMUT chips and ultrasonic systems, delivering complete AIDVD sensing and measurement solutions.",
...
let currentLang = localStorage.getItem("yisonic-lang") || "zh";

const getString = (lang, key) => {
  return content[lang]?.[key] ?? content[fallbackLang]?.[key] ?? "";
};
...
const applyLanguage = (lang) => {
  ...
  document.title = getString(lang, "site-title") || "YiSONIC";
  ...
  localStorage.setItem("yisonic-lang", lang);
};
